...
elif [ -f "/home/denis/.backgroundimg/skybridges-by-john-harris-2560x1600.png" ]; then
	BKG_IMG="/home/denis/.backgroundimg/skybridges-by-john-harris-2560x1600.png"  # Default image
else
